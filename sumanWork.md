...
[Design Input: Image / Figma]
       │
       ▼ (Enforce 100% Pixel-Perfect Accuracy + Signature Form Architecture)
 1. 📄 HTML Code Block: Bootstrap grid + Semantic tags + Bootstrap Navbar / Controls + Signature classes + <span> wrapped list text (UL LI IMG only) + Working CDN Images + HTML <img> background + Single <form> tag with .cmn-form-style & .inpt-wrp + Owl Carousel Markup (Default) / Swiper
 2. 🎨 Stylesheet Code Block (CSS Default / SCSS on request - NO VARIABLES): Matched with 100% precision + HTML <img> absolute positioning rules + .cmn-form-style & .inpt-wrp form styles
...
### 4.2 Contact Form Section Blueprint (Signature Form Structure Rule)

```html
<!-- ============================================
     SECTION: Contact Form (Single <form> Tag & .cmn-form-style)
     ============================================ -->
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 col-md-12">
        ...
        <p>Have questions or want to work with us? Fill out the form below and our team will get back to you shortly.</p>
      </div>
      <div class="col-lg-6 col-md-12">
        <!-- SINGLE <form> TAG FOR ALL INPUTS OF THE SAME CATEGORY -->
        <form action="#" class="cmn-form-style">
          <div class="row">
            <div class="col-md-6">
              <div class="inpt-wrp">
            ...
            <div class="col-md-12">
              <div class="inpt-wrp">
                ...
                <input type="number" placeholder="00 12345 67890">
              </div>
            </div>
            <div class="col-md-12">
              <div class="inpt-wrp">
...
/* ============================================
   SIGNATURE FORM STYLES (.cmn-form-style & .inpt-wrp)
   ============================================ */
.cmn-form-style {
  background-color: #ffffff;
  padding: 2rem;
...
.cmn-form-style .inpt-wrp {
  margin-bottom: 1.25rem;
}

.cmn-form-style .inpt-wrp label {
  display: block;
  font-size: 0.875rem;
  font-weight: 600;
  color: #151515;
...
.cmn-form-style .inpt-wrp input[type="text"],
.cmn-form-style .inpt-wrp input[type="email"],
.cmn-form-style .inpt-wrp input[type="number"],
.cmn-form-style .inpt-wrp textarea {
  width: 100%;
...
.cmn-form-style .inpt-wrp input:focus,
.cmn-form-style .inpt-wrp textarea:focus {
  border-color: #bf8f2d;
}
...
.cmn-form-style input[type="submit"] {
...
.cmn-form-style input[type="submit"]:hover {
...
### 4.4 Responsive CSS Blueprint (`responsive.css` Snippet)
...
I will immediately generate the **HTML** (using your single `<form>` tag and `.cmn-form-style` with `.inpt-wrp` structure), **Stylesheet (CSS/SCSS without variables)**, **Responsive Stylesheet (`responsive.css`)**, and **JS** blocks for that exact section!
